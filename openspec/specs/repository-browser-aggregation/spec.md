# repository-browser-aggregation Specification

## Purpose

定义 Workspace 内 repository-owned browser 的统一 per-Folder 聚合边界，包括 owner-qualified identity、稳定成员顺序、ready/missing/error 状态、partial completeness 与只汇总可读 Folder 的共享契约。
