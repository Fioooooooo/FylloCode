# workflow-proposal-confirmation Specification

## Purpose

定义用户确认或取消 workflow proposal 时的 IPC、definition 持久化、状态幂等、主 Agent handoff 与取消 decision 投递契约，并明确确认流程不创建 workflow Run。
