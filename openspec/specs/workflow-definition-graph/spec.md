# workflow-definition-graph Specification

## Purpose

定义 Workflow Editor 对已解析的 v2 Workflow definition 提供的只读图视图：将阶段、分支和循环关系转换为可渲染的 Mermaid 图，不参与 definition 持久化、Run 执行或 Inspector 状态管理。
