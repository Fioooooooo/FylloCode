...
import { AutomationWorkspaceIntegrationChannels } from "./automation/workspace-integration.channels";

// Compatibility shim: the legacy "Integration" surface spans both platform providers
// and Workspace-level integration settings. New code should use the split domain channels
...
export const IntegrationChannels = {
  ...
  workspaceGet: AutomationWorkspaceIntegrationChannels.get,
  workspaceSet: AutomationWorkspaceIntegrationChannels.set,
} as const;
