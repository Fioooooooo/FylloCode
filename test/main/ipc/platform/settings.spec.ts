...
vi.mock("@main/services/platform/settings/settings-service", () => ({
...
vi.mock("@main/services/platform/release/release-version-service", () => ({
...
describe("registerSettingsHandlers", () => {
  beforeEach(async () => {
    ...
    const { registerReleaseHandlers } = await import("@main/ipc/platform/release");
    const { registerSettingsHandlers } = await import("@main/ipc/platform/settings");
