...
vi.mock("@main/services/proposal/runtime/apply-run-service", () => ({
...
vi.mock("@main/services/session/chat/acp-session", () => ({
...
vi.mock("@main/services/session/chat/message-assembler", () => ({
...
describe("registerProposalApplyHandlers", () => {
  beforeEach(async () => {
    ...
    const { registerProposalArchiveHandlers } = await import("@main/ipc/proposal/archive");
