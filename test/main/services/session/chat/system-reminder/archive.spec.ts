...
import archiveTemplate from "@main/services/session/chat/system-reminder/templates/archive.txt?raw";
...
describe("archive system-reminder template", () => {
  ...
  it("renders the workspace section with archive-change result handling", () => {
    ...
    expect(reminder).toContain("mcp__fyllo_cortex__guidelines");
    expect(reminder).not.toContain(["mcp", "fyllo", "skills", "guidelines"].join("__"));
