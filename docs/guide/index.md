...
4. [Lineage 追溯链路](/guide/lineage)

想参与项目开发，可以继续阅读[贡献指南](/contributing)和[用 FylloCode 开发 FylloCode](/guide/develop-with-fyllocode)。
...
| [lineage](/guide/lineage) | 串联一次变更各阶段的可追溯线索，让固化结果自动作用到下一次任务 |
